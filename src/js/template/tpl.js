...
/*``*/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,$each=$utils.$each,rows=$data.rows,val=$data.val,index=$data.index,$escape=$utils.$escape,total=$data.total,$out='';$each(rows,function(val,index){
$out+='\n<p>\n  ';
$out+=$escape(val.id);
$out+=' -';
$out+=$escape(val.name);
